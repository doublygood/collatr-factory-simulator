...
- [Appendix A: Full Modbus Register Map](appendix-a-modbus-register-map.md)
- [Appendix B: Full OPC-UA Node Tree](appendix-b-opcua-node-tree.md)
- [Appendix C: Full MQTT Topic Map](appendix-c-mqtt-topic-map.md)
- [Appendix D: Configuration Reference](appendix-d-configuration-reference.md)
- [Appendix E: Project Structure](appendix-e-project-structure.md)
- [Appendix F: Implementation Phases](appendix-f-implementation-phases.md)
- [Appendix G: Reference Documents](appendix-g-reference-documents.md)
