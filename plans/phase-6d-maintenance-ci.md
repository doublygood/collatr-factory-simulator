...
**Scope:** YELLOW issues Y16-Y24, Y27 from the three-reviewer code review. Y24 (Dockerfile editable install) was already fixed in Phase 6a — skipped. Y25 (AccessLevel=0 inactive profile) and Y26 (LWT topic) deferred to post-MVP.
